package dlc.tpu.buscador.soporte;
 ...
 * rápida el menor elemento del conjunto, o puede ser descendente, en cuyo caso 
 * está preparado para obtener en forma rapida el mayor. Se puede crear un Heap 
 * ascendente enviando al constructor de la clase el valor true como segundo 
 * parámetro, o crear un Heap descendente enviando un false a ese mismo 
 * constructor:
 *      // un heap ascendente con capacidad inicial = 10
 *      Heap <Integer> ah = new Heap<>(10, true);  
 *      
 *      // un heap descendente con capacidad inicial = 100 (por default)
 *      Heap <Integer> dh = new Heap<>(false);     
 *      
 * La capacidad del Heap irá variando a medida que se requiera. Si la capacidad 
 * no alcanza para una nueva inserción, entonces la capacidad será duplicada 
 * automáticamente. Si al realizar extracciones se detecta que el espacio 
 * ocupado es inferior al 90% de la mitad de la capacidad actual, entonces la 
 * capacidad será automaticamente disminuida a la mitad (siempre que la nueva 
